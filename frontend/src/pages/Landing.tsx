      ...
      <div className="relative z-10" style={{ pointerEvents: 'none' }}>
        ...
        >
          <div className="text-center max-w-5xl mx-auto relative z-10" style={{ pointerEvents: 'none' }}>
            ...
            {/* Logo - Always using dark mode logos */}
            <motion.div
            ...
            >
              ...
              <motion.button
                ...
                className="px-8 py-4 rounded-xl font-semibold text-lg border-2 border-gray-700 text-gray-300 hover:border-cyan-400 hover:text-cyan-400 transition-all"
              >
                Sign In
              </motion.button>
            </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {features.map((feature, idx) => (
                <motion.div
                  ...
                  className="p-6 rounded-2xl border border-gray-700 transition-all duration-300 cursor-pointer bg-[#1a1a2e]/50 hover:border-cyan-500/50 shadow-lg hover:shadow-xl"
                >
